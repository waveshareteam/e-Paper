...
try:
    ...
    LBlackimage = Image.new('1', (epd5in83b.EPD_HEIGHT, epd5in83b.EPD_WIDTH), 255)  # 448*600
    LRedimage = Image.new('1', (epd5in83b.EPD_HEIGHT, epd5in83b.EPD_WIDTH), 255)  # 448*600
    # Vertical
