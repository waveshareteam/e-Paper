...
// Flag to check if the QR code has been displayed
...
void loop() {
    if (!qrCodeDisplayed) {
        ...
        qrCodeDisplayed = true;  // Set the flag to true after displaying the QR code
    }

    // Put the display to sleep to save power after the QR code is displayed
    epd2in9v2.Sleep(); 
}
