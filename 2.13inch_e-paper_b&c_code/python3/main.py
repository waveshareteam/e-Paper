...
try:
    ...
    drawblack.text((10, 20), '2.13 epd b', font = font20, fill = 0)
    ...
    LBlackimage = Image.new('1', (epd2in13b.EPD_WIDTH, epd2in13b.EPD_HEIGHT), 255)  # 126*298
    LRedimage = Image.new('1', (epd2in13b.EPD_WIDTH, epd2in13b.EPD_HEIGHT), 255)  # 126*298
    ...
    drawred.arc((15, 95, 55, 135), 0, 360, fill = 0)
    drawred.chord((15, 155, 55, 195), 0, 360, fill =1)
    epd.display(epd.getbuffer(LBlackimage), epd.getbuffer(LRedimage))
    time.sleep(2)
    
    print("read bmp file")
    HBlackimage = Image.open('2in13b-b.bmp')
    HRedimage = Image.open('2in13b-r.bmp')
    epd.display(epd.getbuffer(HBlackimage.rotate(180)), epd.getbuffer(HRedimage.rotate(180)))
    time.sleep(2)
