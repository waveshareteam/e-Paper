...
void setup() {
    ...
    Paint_NewImage(BlackImage, EPD_3IN6E_WIDTH/2, EPD_3IN6E_HEIGHT, 0, EPD_3IN6E_WHITE);
    Paint_SetScale(6);
    ...
    EPD_3IN6E_Init();
    Paint_NewImage(BlackImage, EPD_3IN6E_WIDTH/2, EPD_3IN6E_HEIGHT, 90, EPD_3IN6E_WHITE);
    Paint_SetScale(6);
    // 1.Select Image
    ...
    printf("EPD_Display\r\n");
    EPD_3IN6E_DisplayPart(BlackImage,200,0,200,600);
    DEV_Delay_ms(3000);
#endif
