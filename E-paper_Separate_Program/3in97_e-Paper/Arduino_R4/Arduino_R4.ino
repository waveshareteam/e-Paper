...
void setup() {
    ...
    Paint_NewImage(BlackImage, EPD_3IN97_WIDTH/2, EPD_3IN97_HEIGHT/2, 0, WHITE);
    Paint_SetScale(2);
    ...
    printf("EPD_Display\r\n");
    EPD_3IN97_V2_Display_Window_Base(BlackImage, 0, 0, EPD_3IN97_WIDTH/2, EPD_3IN97_HEIGHT/2);
    DEV_Delay_ms(3000);
#endif
    ...
    Paint_NewImage(BlackImage, EPD_3IN97_WIDTH/4, EPD_3IN97_HEIGHT/2, 0, WHITE);
    Paint_SetScale(4);
    Paint_Clear(WHITE);
    ...
    EPD_3IN97_WritePicture_4Gray(BlackImage);
    DEV_Delay_ms(3000);
#endif
