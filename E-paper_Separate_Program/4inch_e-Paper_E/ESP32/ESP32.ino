...
void setup() {
    ...
    Paint_NewImage(Image, EPD_4IN0E_WIDTH/2, EPD_4IN0E_HEIGHT, 0, EPD_4IN0E_WHITE);
    Paint_SetScale(6);
    ...
    Paint_NewImage(Image, EPD_4IN0E_WIDTH/2, EPD_4IN0E_HEIGHT, 90, EPD_4IN0E_WHITE);
    Paint_SetScale(6);
    // 1.Select Image
    ...
    printf("EPD_Display\r\n");
    EPD_4IN0E_DisplayPart(Image, 100, 150, 200, 600);
    DEV_Delay_ms(3000);
#endif
